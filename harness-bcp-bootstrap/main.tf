...
resource "local_file" "template" {
  ...
  content = templatefile("../contrib/harness/templates/terraform-pipeline.tpl", {
    ...
    git_connector_ref  = "org.bcp_lab_github_connector" # TODO: get name dynamically
    ...
    tf_variables = {
      ...
      # connector_bcp_github_token      = "<+secrets.getValue(\"connector_bcp_github_token\")>"
      # connector_bcp_docker_token      = "<+secrets.getValue(\"connector_bcp_docker_token\")>"
      # connector_bcp_artifactory_token = "<+secrets.getValue(\"connector_bcp_artifactory_token\")>"
    }
  })
